...
plot_scores <- plot_scores + labs(tag = "A")
plot_velocity_gs[[1]][[1]] <- plot_velocity_gs[[1]][[1]] + labs(tag = "B")
plot_velocity_gs[[2]][[1]] <- plot_velocity_gs[[2]][[1]] + labs(tag = "C")
plot_velocity_arrows[[1]] <- plot_velocity_arrows[[1]] + labs(tag = "D")
