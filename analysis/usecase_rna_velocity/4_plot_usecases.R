...
# Combine plots
plot_part_A <- patchwork::wrap_plots(plot_trajectory, expression_plot, gs_plot, nrow = 1)
...
plot_part_B <- pmap(design_velocity_oi, function(dataset_id, method_id, params_id, ...) {
...
plot_part_C <- pmap(design_velocity_oi, function(dataset_id, method_id, params_id, params, ...) {
...
plot_part_D <- plot_part_D + labs(tag = "D")
