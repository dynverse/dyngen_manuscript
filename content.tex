...
\begin{figure}[htb!]
	...
	\caption{Showcase of dyngen functionality. Remove B? \textit{Yes please}} % TODO: update label
	\label{fig:dyngen}
\end{figure}
...
\mycomment{GRN is defined nowhere}
...
\mycomment{explain what is meant by 'sampling' and 'profiling technique' a little better}
...
\mycomment{show that dyngen output resembles real data using e.g. countsimQC?}
...
\section{Methods}
\mycomment{The method section is REALLY rough at this stage.}
...
\mycomment{mention strength and cooperativity.}
...
\mycomment{Welcome to the beginning of the end}
...
\mycomment{TODO: add step-by-step  derivation of transcription formula}
...
\mycomment{this is basically an ODE, though we never reference ODEs anywhere. Maybe this is ok, this simplifies the section a bit?}
