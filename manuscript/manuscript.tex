...
\hypersetup{
  pdftitle={dyngen is a multi-modal simulator for spearheading future single-cell omics analyses},
...
\title{dyngen is a multi-modal simulator for spearheading future
...
countsimQC \autocite{soneson_unifiedqualityverification_2018}. .
