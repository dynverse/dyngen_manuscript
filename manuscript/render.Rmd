...
\begin{figure}[t!]
    ...
    \caption{
      ...
      \textbf{A:} Trajectory alignment aligns two trajectories between samples. We use dyngen to evaluate dynamic time warping (DTW) and cellAlign when aligning two linear trajectories with different kinetic parameters.
...
## Comparison of trajectory alignment {#sec:dyngen-tacompare}[c]
...
[a]todo: update
[b]// todo: upload temporary data to zenodo?
[c]todo: update this section
[d]@louise.deconinck@gmail.com could you add a description for cellAlign?
_Assigned to Louise_
[e]TODO: rename
[f]TODO: update text
